...
contract Liquidity is IERC721Receiver {
    ...
    // 0.01% fee
    /** Defining the fee to charge when someone swaps*/
    uint24 public constant poolFee = 100;

    INonfungiblePositionManager public nonfungiblePositionManager =
        INonfungiblePositionManager(0xC36442b4a4522E871399CD717aBDD847Ab11FE88);

    /// @notice Represents the deposite of an NFT
    struct Deposit {
        address owner;
        uint128 liquidity;
        address token0;
    ...
    {
        // In this , we will provide equal amounts of liquidity in both assets.
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        // alternatively can set recipient to msg.sender and avoid another transaction in `setToOwner`
